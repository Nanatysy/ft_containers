...
//			}
			...
			_map_iterator<Iter> &operator--()
			{
				...
				if (_ptr == _tree->_end)
					return (*this);
				if (_ptr->left == _tree->_leaf || _ptr->left == _tree->_leaf)
				{
					parent = _ptr->parent;
	...
	public:
		...
		typedef _map_reverse_iterator<iterator> reverse_iterator;
		typedef _map_reverse_iterator<const_iterator> const_reverse_iterator;
